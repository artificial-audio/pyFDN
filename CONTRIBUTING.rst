...
* ``src/pyFDN/train/`` contains the trainable FDN construction, the composable
  losses in ``train/losses/``, and the optimization loop. ``src/pyFDN/auxiliary/`` holds shared analysis,
