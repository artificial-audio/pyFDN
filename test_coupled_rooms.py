...
from pyFDN.examples.example_coupled_rooms import tiny_rotation_matrix, create_coupled_rooms_fdn
...
def test_tiny_rotation_matrix():
    ...
    assert max_diff > 1e-6, f"Different seeds should produce different matrices"
