...
def _(mo):
    ...
    A six-line FDN from the gallery, mono in and stereo out: random orthogonal feedback, a first-order absorption shelf per delay line (1.8 s at DC, 0.4 s at Nyquist, crossing at `fs/8`), unity direct path.
